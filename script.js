...
const api_url = "https://destroyeraynaan.herokuapp.com/user"
...
function getDataByContact(contact) {
	fetch("https://destroyeraynaan.herokuapp.com/find", {
		method: "POST",
		headers: {
...
function postData() {
	...
	fetch("https://destroyeraynaan.herokuapp.com/entry", {
		method: "POST",
		headers: {
		  'Accept': 'application/json',
		  'Content-Type': 'application/json'
...
function updateData() {
	...
	fetch("https://destroyeraynaan.herokuapp.com/update", {
		method: "POST",
		headers: {
		  'Accept': 'application/json',
		  'Content-Type': 'application/json'
...
function deleteData(contact) {
	...
	if(user_input) {
		fetch("https://destroyeraynaan.herokuapp.com/delete", {
			method: "POST",
			headers: {
			  'Accept': 'application/json',
			  'Content-Type': 'application/json'
